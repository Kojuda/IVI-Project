...
if __name__ == '__main__':
    # ~~~~~~~~~~~~~~~ Configuration ~~~~~~~~~~~~~~~ #
    url = 'https://www.fake-id.com/'
    filename_prefix = 'fakeidcom'
    tor = False
    headless = True
    ...
    browser.driver.execute_script("window.scrollTo(0, window.innerHeight);") #window.innerHeight retourne la hauteur de la fenêtre
    ...
    doc.info['selenium'] = []
    info['actions'].append('driver.execute_script("window.scrollTo(0, window.innerHeight);")')
