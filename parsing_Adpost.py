...
#Parse_ads(title=parse_data.get('title'), category= parse_data.get('Category'), ad_number= parse_data.get('Ad Number'), breed = parse_data.get('Breed'), age = parse_data.get('Age'), sex= parse_data.get('Sex'), primary_color = parse_data.get('Primary Color'), \
#secondary_color= parse_data.get('Secondary Color'), advertiser= parse_data.get('Advertiser'), price= parse_data.get('Price'), ad_number= parse_data.get('Ad Number')ad_number= parse_data.get('Ad Number')ad_number= parse_data.get('Ad Number')ad_number= parse_data.get('Ad Number')ad_number= parse_data.get('Ad Number')ad_number= parse_data.get('Ad Number')ad_number= parse_data.get('Ad Number')ad_number= parse_data.get('Ad Number')ad_number= parse_data.get('Ad Number')ad_number= parse_data.get('Ad Number')ad_number= parse_data.get('Ad Number')ad_number= parse_data.get('Ad Number')).insertParse_ads(session)
